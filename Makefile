...
all: $(OBJS)
	...
	g++ acutest.h vector.cpp negativeList.cpp list.cpp  vertex.cpp bucket.cpp hashTable.cpp Job.cpp Queue.cpp JobScheduler.cpp BF.cpp functions.cpp tests.cpp -o tests -lpthread
